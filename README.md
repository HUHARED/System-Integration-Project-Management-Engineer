...
库中还包含思维导图文件，遇到思维导图和笔记对应章节内容不一致的情况，以笔记内容为准。
本笔记内容主要是网上免费视频学习、做题过程中整理的，而且软考不公布官方答案，所以本笔记内容可能有错误。
笔记中有少量包含个人情绪的脏话，不打算改，各位看着不舒服可以自行替换。

目录

- [1. 杂项概念题，一般是选择题](#1-杂项概念题一般是选择题)
  - [1.1. 狗屁概念](#11-狗屁概念)
    - [1.1.1. 信息系统建设务能力等级](#111-信息系统建设务能力等级)
    - [1.1.2. 信息系统生命周期](#112-信息系统生命周期)
    - [1.1.3. IT服务声明周期](#113-it服务声明周期)
    - [1.1.4. 国家信息化](#114-国家信息化)
      - [数字化转型](#数字化转型)
      - [国家信息化体系6要素](#国家信息化体系6要素)
      - [《“十四五”信息化和工业化深度融合发展规划》](#十四五信息化和工业化深度融合发展规划)
    - [1.1.5. 供应链](#115-供应链)
      - [按物理结构分类](#按物理结构分类)
      - [供应链特点](#供应链特点)
      - [供应链三个阶段](#供应链三个阶段)
    - [1.1.6. 大数据](#116-大数据)
    - [1.1.7. 商业智能（Business Intelligence，BI）](#117-商业智能business-intelligencebi)
      - [主要功能](#主要功能)
      - [实现层次](#实现层次)
      - [步骤](#步骤)
    - [1.1.8. 物联网架构](#118-物联网架构)
    - [1.1.9. 中间件](#119-中间件)
    - [1.1.10. 合同变更](#1110-合同变更)
    - [1.1.11. 标准化](#1111-标准化)
      - [标准制定的9个阶段](#标准制定的9个阶段)
      - [标准类别](#标准类别)
      - [一些标准组织缩写](#一些标准组织缩写)
    - [1.1.12. 软件工程](#1112-软件工程)
      - [常用开发方法](#常用开发方法)
      - [迭代模型（统一软件开发过程RUP（Tational Unifidd Process)）](#迭代模型统一软件开发过程ruptational-unifidd-process)
      - [分布式应用](#分布式应用)
    - [1.1.13. 提升云计算自主创新能力](#1113-提升云计算自主创新能力)
    - [1.1.14. CRM：Customer Relationship Management客户关系管理](#1114-crmcustomer-relationship-management客户关系管理)
    - [1.1.15. SOA与Web Service](#1115-soa与web-service)
    - [1.1.16. 计算机网络分类](#1116-计算机网络分类)
  - [1.2. 不算太狗屁概念](#12-不算太狗屁概念)
    - [1.2.1. 信息安全](#121-信息安全)
      - [信息安全的基本要素（信息系统审计的关注点）](#信息安全的基本要素信息系统审计的关注点)
      - [典型网络攻击步骤](#典型网络攻击步骤)
      - [人员离岗安全管理](#人员离岗安全管理)
      - [信息系统安全保护等级](#信息系统安全保护等级)
      - [机房防静电](#机房防静电)
    - [1.2.2. 项目付款合同分类](#122-项目付款合同分类)
    - [1.2.3. 承包合同类型](#123-承包合同类型)
    - [1.2.4. OSI模型](#124-osi模型)
    - [1.2.5. 虚拟现实的典型特征](#125-虚拟现实的典型特征)
    - [1.2.6. 自动驾驶](#126-自动驾驶)
- [2. 项目管理杂项题（选择、填空都有）](#2-项目管理杂项题选择填空都有)
  - [2.1. 项目的三个特点](#21-项目的三个特点)
  - [2.2. 项目目标](#22-项目目标)
  - [2.3. 项目管理的特点](#23-项目管理的特点)
  - [2.4. 项目组织类型（根据项目经理权限高低来区分）](#24-项目组织类型根据项目经理权限高低来区分)
  - [2.5. 项目经理的5种权力](#25-项目经理的5种权力)
    - [2.5.1. 给予激励的斯洛需求层次理论](#251-给予激励的斯洛需求层次理论)
  - [2.6. 项目立项（项目建议书、立项申请）](#26-项目立项项目建议书立项申请)
  - [2.7. 可行性研究](#27-可行性研究)
  - [2.8. 项目管理过程组](#28-项目管理过程组)
  - [2.9. 项目活动的依赖关系](#29-项目活动的依赖关系)
  - [2.10. 活动排列顺序（活动网络图）](#210-活动排列顺序活动网络图)
    - [2.10.1. 图形](#2101-图形)
    - [2.10.2. 活动时间（通常使用关键路径法画图计算）](#2102-活动时间通常使用关键路径法画图计算)
    - [2.10.3. 调整进度的工具技术](#2103-调整进度的工具技术)
    - [2.10.4. 分解结构区分](#2104-分解结构区分)
      - [工作分解结构（Work Breakdown Structure，WBS）](#工作分解结构work-breakdown-structurewbs)
      - [资源分解结构（Resource Breakdown Structure，RBS）](#资源分解结构resource-breakdown-structurerbs)
      - [组织分解结构（Organizational Breakdown Structure，OBS）](#组织分解结构organizational-breakdown-structureobs)
      - [责任分配矩阵（Responsibility Assignment Matrix，RAM）](#责任分配矩阵responsibility-assignment-matrixram)
- [3. 项目整体管理](#3-项目整体管理)
  - [3.1. 制定项目章程](#31-制定项目章程)
    - [3.1.1. 作用](#311-作用)
    - [3.1.2. 输入](#312-输入)
    - [3.1.3. 工具\&技术](#313-工具技术)
    - [3.1.4. 输出](#314-输出)
  - [3.2. 制定项目管理计划](#32-制定项目管理计划)
    - [3.2.1. 作用](#321-作用)
    - [3.2.2. 输入](#322-输入)
    - [3.2.3. 工具\&技术](#323-工具技术)
    - [3.2.4. 输出](#324-输出)
    - [3.2.5. 三大基准](#325-三大基准)
      - [范围基准](#范围基准)
        - [项目说明书](#项目说明书)
        - [工作分解结构（Wrok Breakdown Structure, WBS)★★★★★](#工作分解结构wrok-breakdown-structure-wbs)
          - [作用](#作用)
          - [处理过程](#处理过程)
          - [案例题问WBS存在什么不合理](#案例题问wbs存在什么不合理)
          - [输入](#输入)
          - [工具\&技术](#工具技术)
          - [输出](#输出)
          - [名词概念](#名词概念)
    ...
    - [3.2.6. 9个子计划](#326-9个子计划)
      ...
      - [质量](#质量)
        ...
        - [质量控制](#质量控制)
          ...
          - [输出](#输出-3)
          - [质量成本](#质量成本)
          - [质量审计（aka质量保证体系审核）](#质量审计aka质量保证体系审核)
          - [质量控制七种工具（图形）与作用](#质量控制七种工具图形与作用)
          - [【确认范围】过程、【质量控制】过程的区别](#确认范围过程质量控制过程的区别)
      - [沟通（沟通管理）](#沟通沟通管理)
      - [风险](#风险)
        - [风险按性质分类](#风险按性质分类)
        - [风险特征](#风险特征)
        - [风险管理过程](#风险管理过程)
        - [风险识别](#风险识别)
          - [制定风险清单（风险登记册和风险清单有什么区别我也不知道，可能就是同一个）](#制定风险清单风险登记册和风险清单有什么区别我也不知道可能就是同一个)
          - [风险登记册★★★](#风险登记册)
          - [识别风险的工具和技术](#识别风险的工具和技术)
        - [风险控制](#风险控制)
          - [风险应对策略](#风险应对策略)
        - [定量风险分析](#定量风险分析)
          - [输入](#输入-4)
      ...
      - [人力资源](#人力资源)
      - [干系人](#干系人)
    - [3.2.7. 其他4个子计划](#327-其他4个子计划)
  - [3.3. 指导\&管理相关工作](#33-指导管理相关工作)
    - [3.3.1. 作用](#331-作用)
    - [3.3.2. 输入](#332-输入)
    - [3.3.3. 工具\&技术](#333-工具技术)
    - [3.3.4. 输出](#334-输出)
    - [3.3.5. 软件配置管理活动](#335-软件配置管理活动)
    - [3.3.6. 组件项目团队](#336-组件项目团队)
      - [输入](#输入-7)
    - [3.3.7. 输出](#337-输出)
    - [3.3.8. 冲突管理](#338-冲突管理)
      - [冲突的特点](#冲突的特点)
      - [冲突解决方法](#冲突解决方法)
    - [3.3.9. 人力资源管理](#339-人力资源管理)
      - [工具\&技术](#工具技术-6)
      - [团队组建](#团队组建)
        - [输入](#输入-8)
        - [工具\&技术](#工具技术-7)
      ...
      - [团队建设](#团队建设)
        - [工具\&技术](#工具技术-8)
    - [3.3.10. 干系人管理](#3310-干系人管理)
      - [管理策略（权利/利益方格）](#管理策略权利利益方格)
      - [干系人分类四大模型](#干系人分类四大模型)
      - [干系人清单](#干系人清单)
      - [干系人管理的内容（过程）](#干系人管理的内容过程)
  - [3.4. 监控项目工作](#34-监控项目工作)
    - [3.4.1. 作用](#341-作用)
    - [3.4.2. 输入](#342-输入)
    - [3.4.3. 工具\&技术](#343-工具技术)
    - [3.4.4. 输出](#344-输出)
    - [3.4.5. 分析技术类别](#345-分析技术类别)
    - [3.4.6. 计算绩效](#346-计算绩效)
      - [EV-Earned Value-挣值](#ev-earned-value-挣值)
      - [PV-Planned Value-计划值](#pv-planned-value-计划值)
      - [AC-Actual Cost-实际成本](#ac-actual-cost-实际成本)
      - [CPI-Cost Performance Index-成本执行指标（成本绩效）](#cpi-cost-performance-index-成本执行指标成本绩效)
      - [SPI-Schedule Performed index-进度执行指标（进度绩效）](#spi-schedule-performed-index-进度执行指标进度绩效)
      - [CV-成本偏差](#cv-成本偏差)
      - [SV-进度偏差](#sv-进度偏差)
      - [BAC-Budget Cost at Completion-完工预算](#bac-budget-cost-at-completion-完工预算)
      - [ETC-Estimate to Complete-完工尚需估算](#etc-estimate-to-complete-完工尚需估算)
      - [EAC-Estimate at Completion-完工估算](#eac-estimate-at-completion-完工估算)
      - [VAC-Variance at Completion-完工偏差](#vac-variance-at-completion-完工偏差)
      - [TCPI-To Completion Performance Index-完工尚需绩效指数](#tcpi-to-completion-performance-index-完工尚需绩效指数)
      - [标准差](#标准差)
      - [常见案例题](#常见案例题)
        - [进度已经滞后了，为了提升执行绩效（赶进度），怎么办？](#进度已经滞后了为了提升执行绩效赶进度怎么办)
        - [进度落后，成本节约怎么办？](#进度落后成本节约怎么办)
        - [进度超前，成本超支怎么办？](#进度超前成本超支怎么办)
        - [进度超前，成本节约怎么办？](#进度超前成本节约怎么办)
        - [计算成本会超支多少](#计算成本会超支多少)
        - [要求评估「执行绩效」：](#要求评估执行绩效)
  - [3.5. 实施整体变更控制](#35-实施整体变更控制)
    - [3.5.1. 变更原因](#351-变更原因)
    - [3.5.2. 输入](#352-输入)
    - [3.5.3. 工具\&技术](#353-工具技术)
    - [3.5.4. 输出](#354-输出)
    - [3.5.5. 变更管理基本原则](#355-变更管理基本原则)
  - [3.6. 结束项目或阶段](#36-结束项目或阶段)
    - [3.6.1. 作用](#361-作用)
    - [3.6.2. 输入](#362-输入)
    - [3.6.3. 工具\&技术](#363-工具技术)
    - [3.6.4. 输出](#364-输出)
    - [3.6.5. 收尾的分类](#365-收尾的分类)
- [4. 答题技巧](#4-答题技巧)
  - [4.1. 英语题](#41-英语题)
  - [4.2. 判断题](#42-判断题)
  - [4.3. 上午题（选择题）](#43-上午题选择题)
    - [4.3.1. 考察范围是有顺序的](#431-考察范围是有顺序的)
    - [4.3.2. 关键词](#432-关键词)
  - [4.4. 下午题（案例题）](#44-下午题案例题)
    - [4.4.1. 常见问题与对策](#441-常见问题与对策)
    - [4.4.2. 案例分析问「存在什么问题」的解题思路，回答模式](#442-案例分析问存在什么问题的解题思路回答模式)
    - [4.4.3. 包含、属于哪些内容、流程](#443-包含属于哪些内容流程)
    - [4.4.4. 案例分析问应该做哪些调整的思路、模式](#444-案例分析问应该做哪些调整的思路模式)
    - [4.4.5. 计算题如果参与运算的数字多，得多算用不同方式算几遍，免得错。](#445-计算题如果参与运算的数字多得多算用不同方式算几遍免得错)
    - [4.4.6. 计算题最后记得写单位（元、万元、日、周等）](#446-计算题最后记得写单位元万元日周等)
    - [4.4.7. 问最晚开始时间](#447-问最晚开始时间)
    - [4.4.8. 不会的判断题优先选√](#448-不会的判断题优先选)
- [5. 计算题专题整理](#5-计算题专题整理)
  - [5.1. 加权算法](#51-加权算法)
  - [5.2. 自购、外购分析](#52-自购外购分析)
  - [5.3. 沟通渠道](#53-沟通渠道)
    - [5.3.1. 沟通渠道：n(n-1)/2](#531-沟通渠道nn-12)
    - [5.3.2. 计算需要开发的月数](#532-计算需要开发的月数)
  - [5.4. 三点估算PERT](#54-三点估算pert)
    - [5.4.1. 期望完成时间](#541-期望完成时间)
    - [5.4.2. 标准差](#542-标准差)
    - [5.4.3. 正态分布曲线](#543-正态分布曲线)
  - [5.5. 进度网络图](#55-进度网络图)
    - [5.5.1. 双代号时标网络图](#551-双代号时标网络图)
  - [5.6. 挣值分析、预测技术](#56-挣值分析预测技术)
...
#### 迭代模型（统一软件开发过程RUP（Tational Unifidd Process)）
...
驾驶员可以稍息下，但仍需**紧绷神经时刻观察**，得像监考老师的鹰眼一般，做好接手驾驶的准备，所以叫有条件的自动化，这里驾驶员的重要性已经在降低。

L4 高度自动化

这里车辆就几乎达到了替代驾驶员的情况，就像出师的徒弟一般，**驾驶员可以休息**，如果想感受驾驶乐趣的话也可以接管车辆。
...
* 自由浮动时间（自由时差）
  * 理解：不延误紧后活动、不违反进度制约因素的可推迟时间
    * 当前节点的下一节点如果有多个输入，则当前节点可能会有自由浮动时间（否则没有自由浮动时间）。因为可能有其他耗时非常长的活动，把下一节点的最早开始时间推迟了。
...
之前没遇到过这种，不确定能不能这么算，总之先记一下吧，非关键路径上，可能还有比所考节点所在路径更关键一些的路径，那么所考节点的最晚结束时间就是紧后节点的最晚开始时间。或者应该从时标网络图的角度理解，这个总时差就是节点之后波浪线最短的路径的波浪线总长度？
...
##### 工作分解结构（Wrok Breakdown Structure, WBS)★★★★★
...
* 工作包
  * 最底层的可交付成果，如果一个交付成果可以在**8-80**小时内完成或**逻辑上不可再分**，它就可被认为是一个工作包。
* 活动
  * 工作包再细分的单元，最基本的单元
...
质量两个直接相关的：质量测量指标、质量核对单（产生自规划，供控制使用）。
...
* 质量控制测量结果
* 核实的可交付成果（质量检查结束后，没问题就可以交付了）
* 工作绩效信息（用来评价每个人的工作质量）
* 变更请求（注意不是「批准的变更请求」，理解为质量检查后提出要修改的地方）
* 管理计划、组织过程资产更新
...
###### 制定风险清单（风险登记册和风险清单有什么区别我也不知道，可能就是同一个）
...
#### CPI-Cost Performance Index-成本执行指标（成本绩效）
...
#### SPI-Schedule Performed index-进度执行指标（进度绩效）
...
就是算出每月的人员生产力-每月的沟通消耗，就是每月实际生产力。然后算需要多少个月。
...
3. 先在一条水平线上，把关键路径上的节点都画出来。（左侧是留空的圈○，上方是大写字母）
4. 把剩余的活动画在图里：
   1. 从关键路径上方或下方引出新的节点，
   2. 然后用波浪线表示自由时差。
   3. 非关键路径的节点回到关键路径时，注意画垂直方向的实线箭头，同样箭头开始要画圈○。
...
计算利润因为压缩工期的变化，注意有没有「每天间接费用」，总工期被压缩了几天，则节省了几天的间接费用。实际增加支出=压缩节点的天数×压缩节点每天增加费用-每天间接费用×压缩天数。
...
注意数值中的0太多的，演草纸计算时可以用K、W来替换，答题纸上要好好写。还要记得写单位（元、万元）
