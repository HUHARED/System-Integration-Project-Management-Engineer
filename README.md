...
##### 3.4.6.1.1. PV-Planned Value-计划值
...
##### 3.4.6.1.2. AC-Actual Cost-实际成本

实际成本会给出来（比如当前子计划实际已经花了多少钱）

就是每个子任务加起来总计已经花费了多少钱（预算）。

##### 3.4.6.1.3. CPI-Cost Performance Index-成本执行指标（成本绩效）
...
##### 3.4.6.1.4. SPI-Schedule Performed index-进度执行指标（进度绩效）
...
##### 3.4.6.1.7. BAC-Budget Cost at Completion-完工预算

预计用于完成项目所花费的总预算。

题目会直接给出来，或者给出各个子计划的预算，求和。

##### 3.4.6.1.8. ETC-Estimate to Complete-完工尚需估算

ETC=BAC-EV

1. 非典型偏差（后期不会出现相同情况）才能这么算，
   即总预算-挣值（已完成预算）
...
##### 3.4.6.1.9. EAC-Estimate at Completion-完工估算
...
##### 3.4.6.1.10. VAC-Variance at Completion-完工偏差
...
##### 3.4.6.1.11. TCPI-To Completion Performance Index-完工尚需绩效指数
...
###### 3.4.6.1.13.1. 进度已经滞后了，为了提升执行绩效（赶进度），怎么办？
